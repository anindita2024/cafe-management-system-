...
class cafe_management():
        ...
        def __init__(self):
                ...
                self.heading = Label(self.root,text="Cafe Management System ",font=('verdana',20,'bold'),fg="red",bg="white")
                self.heading.place(x=60,y=5)

        
                self.style1 = Label(self.root,bg="red",height=1,width=17)
                self.style1.place(x=0,y=50)
                self.style2 = Label(self.root,bg="red",height=1,width=30)
                ...
                self.cafe_icon = ImageTk.PhotoImage(Image.open('hello.jpg'))
                self.logo = Label(self.root,image=self.cafe_icon,bg="white")
                self.logo.place(x=230,y=70)

                # ================== Items ===================
                self.frame1 = LabelFrame(self.root,text="Cafe Items",width=150,height=200,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="red")
                self.frame1.place(x=30,y=90)
                
                self.tea = Label(self.frame1,text="Tea",font=('verdana',10,'bold'),bg="white")
                self.tea.place(x=3,y=1)
                self.tea_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.coffee_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.sandwitch_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.cake_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.burger_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.pizza_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.fries_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.pepsi_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="red")
                self.pepsi_item.place(y=140,x=85)

                # ============ Items Bill =================

                self.frame2 = LabelFrame(self.root,text="Cafe Items Bills",width=180,height=160,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="red")
                ...
                self.items_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.service_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.sub_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.paid_tax = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="red")
                ...
                self.total_bill = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="red")
                self.total_bill.place(y=100,x=100)

                # ================== Calculator ============
                self.frame3 = LabelFrame(self.root,text="Calculator",font=('verdana',10,'bold'),fg="red",bg="white",highlightbackground="white",width=135,height=150,borderwidth=3,relief=RIDGE)
                self.frame3.place(x=360,y=90)

                self.result = Entry(self.frame3,width=19,relief=SUNKEN,borderwidth=3)
                self.result.place(x=2,y=0)

                self.nine = Button(self.frame3,text="9",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.nine)
                self.nine.place(x=0,y=24)
                self.eight = Button(self.frame3,text="8",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.eight)
                self.eight.place(x=32,y=24)
                self.seven = Button(self.frame3,text="7",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.seven)
                ...
                self.six = Button(self.frame3,text="6",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.six)
                self.six.place(x=0,y=50)
                self.five = Button(self.frame3,text="5",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.five)
                self.five.place(x=32,y=50)
                self.four = Button(self.frame3,text="4",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.four)
                ...
                self.three = Button(self.frame3,text="3",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.three)
                self.three.place(x=0,y=76)
                self.two = Button(self.frame3,text="2",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.two)
                self.two.place(x=32,y=76)
                self.one = Button(self.frame3,text="1",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.one)
                ...
                self.zero = Button(self.frame3,text="0",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.zero)
                self.zero.place(x=0,y=102)
                self.clear = Button(self.frame3,text="C",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.clear)
                self.clear.place(x=32,y=102)
                self.equal = Button(self.frame3,text="=",padx=6,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.equal)
                ...
                self.Total_Bills_btn = Button(self.root,text="Total",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.Total_Bill)
                self.Total_Bills_btn.place(x=360,y=245)
                
                self.Clear_btn = Button(self.root,text="Clear",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",command=self.Clear)
                self.Clear_btn.place(x=410,y=245)
        
                self.icon = ImageTk.PhotoImage(Image.open('wrong.png'))
                self.Quit_btn = Button(self.root,image=self.icon,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='red',fg="white",padx=5,command=self.Quit)
